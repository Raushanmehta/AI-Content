  ...
  return (
    <div>  
      ...
      overflow-hidden mx-auto md:py-0 mt-16'>   
        ...
        <h1 className='text-white justify-center text-7xl font-bold  items-center text-center'>
          Ai Content <span className='bg-gradient-to-tl from-purple-500 via-orange-500 to-yellow-500 
          text-transparent bg-clip-text'> Generator</span>
        </h1>
        <div className='p-4 w-full text-center'>
          <p className='text-white justify-center items-center  text-center text-4xl font-bold'>
          ...
          <div className="mt-8 flex justify-center items-centern gap-7">
            <div className='rounded-full border-2 py-2 px-4 text-xl cursor-pointer orange-button'>
              <Link
